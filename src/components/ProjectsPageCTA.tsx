...
import { projectsPageCopy } from "@/lib/sections";

export function ProjectsPageCTA() {
  const { ctaLead, ctaHighlight, contact } = projectsPageCopy;
      ...
      <div className="mx-auto w-full max-w-[1520px]">
        <div className="max-w-[760px]">
          <p className="text-[clamp(1.75rem,3.2vw,2.75rem)] leading-[1.25] font-medium tracking-[-0.04em] text-[#0a0a0a]/60">
            {ctaLead}{" "}
            <span className="font-semibold text-[#0a0a0a]">{ctaHighlight}</span>
          </p>
