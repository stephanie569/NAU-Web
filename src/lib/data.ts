...
export const projects = [
  {
    ...
    description:
      "A complete brand refresh for a logistics startup, increasing recognition by 40%.",
  },
  {
    ...
    description:
      "Multi-channel campaign that drove a 60% increase in qualified leads.",
  },
  {
    ...
    description:
      "Product launch site with conversion rate improvement from 4.2% to 5.9%.",
  },
  {
    ...
    description:
      "Studio identity system with brand guidelines and digital presence.",
  },
  {
    ...
    description:
      "Mobile-first experience platform with seamless booking flow.",
  },
  {
    ...
    description:
      "Enterprise dashboard redesign with improved UX and 23% lower bounce rate.",
  },
];
